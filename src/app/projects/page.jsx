...
//   // 💡 Add state for dynamic padding
//   const [centerPadding, setCenterPadding] = useState("0px");

//   // --- Swiping/Dragging State (Unchanged) ---
...
//   // 💡 Bottom Slider Navigation Functions (Unchanged)
//   const nextModel = () => {
...
//   // 💡 Dynamic Navigation Handler (Unchanged)
...
//   // 💡 NEW: Function to calculate the required padding for centering
//   const calculatePadding = useCallback(() => {
//     if (modelRef.current) {
//       const container = modelRef.current;
//       // Assuming all thumbnails have the same size (w-[340px] h-[200px])
...
//         // Formula: (Container Width / 2) - (Thumbnail Width / 2)
//         const padding = containerWidth / 2 - thumbWidth / 2;
//         setCenterPadding(`${padding}px`);
//       }
//     }
//   }, []);

//   // 💡 NEW: Call padding calculation on initial render and window resize
//   useEffect(() => {
//     calculatePadding();
...
//   // --- Centering Logic for Thumbnails (Updated) ---
...
//       if (activeThumb) {
//         // Scroll position calculation is now correct due to padding
...
//   useEffect(() => {
//     // Recenter when activeModel changes
//     centerThumbnail();
//   }, [activeModel, centerThumbnail]);

//   // --- 1. Touch Swiping Handlers (Mobile) (Unchanged) ---
...
//   // --- 2. Mouse Dragging Handlers (Desktop) (Unchanged) ---
//   const onMouseDown = (e) => {
//     setIsDragging(true);
...
//     // Logic to snap to the closest thumbnail after drag ends (This will be fixed by the padding)
//     const container = modelRef.current;
...
//         {/* List of Main Slides and Content (Unchanged) */}
//         <div className="list">
...
//                 <p
//                   className={`${index === activeItem ? "animate-show-content-1" : ""} uppercase tracking-[10px] transform translate-y-[30px] opacity-0`}
//                 >
//                   {item.type}
//                 </p>
//                 <h2
//                   className={`${index === activeItem ? "animate-show-content-2" : ""} text-[100px] m-0 max-[678px]:text-[60px] transform translate-y-[30px] opacity-0`}
//                 >
//                   {item.title}
//                 </h2>
//                 <p
//                   className={`${index === activeItem ? "animate-show-content-3" : ""} transform translate-y-[30px] opacity-0`}
//                 >
//                   {item.description}
//                 </p>
//               </div>
...
//         {/* Navigation Arrows for Main Slider (Unchanged) */}
...
//           {/* Centered Scrollable Thumbnails */}
//           <div
//             ref={modelRef}
...
//             // 💡 IMPORTANT: Apply dynamic padding here
//             style={{ paddingLeft: centerPadding, paddingRight: centerPadding }}
//             className={`flex gap-4 w-[950px] h-[240px] py-4 box-border 
//                                    overflow-x-scroll scroll-smooth items-center
...
//             ))}
//           </div>
//           {/* End Centered Scrollable Thumbnails */}

//           {/* 💡 Thumbnail Arrow Right (Unchanged) */}
//           <button
//             onClick={nextModel}
//             disabled={activeModel === sliderData[activeItem].models.length - 1}
//             className="z-20 bg-white/30 w-10 h-10 rounded-full text-xl text-white hover:bg-white hover:text-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
//           >
//             &gt;
//           </button>
//         </div>
//         {/* End Model Thumbnails Container */}
//       </div>
//     </div>
//   );
// }
