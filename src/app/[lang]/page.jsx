...
export async function generateMetadata({ params }) {
  ...
  return {
    title: dictionary.metadata?.title || "Your Company Name",
...
export default async function Home({ params }) {
  ...
  const structuredData = {
    ...
    potentialAction: {
      '@type': 'SearchAction',
      target: `https://yourdomain.com/${lang}/search?q={search_term_string}`,
      'query-input': 'required name=search_term_string'
    }
  };
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen w-full overflow-x-hidden">
        {/* Hero Section */}
        <section aria-label={dictionary.hero?.ariaLabel || "Main hero section"}>
        ...
        {/* About Section */}
        <section id="about" aria-label={dictionary.about?.ariaLabel || "About us"} className="scroll-mt-20">
          <About dictionary={dictionary.about} lang={lang} />

        </section>

        {/* Our Business Section */}
        <section id="business" aria-label={dictionary.business?.ariaLabel || "Our business"} className="scroll-mt-20">
          <OurBusiness dictionary={dictionary.business} lang={lang} />
        </section>

        {/* Features/Services Section */}
        <section id="features" aria-label={dictionary.features?.ariaLabel || "Our features"} className="scroll-mt-20">
          <Features dictionary={dictionary.features} lang={lang} />
        </section>

        {/* Story/Testimonials Section */}
        <section id="story" aria-label={dictionary.story?.ariaLabel || "Our story"} className="scroll-mt-20">
          <Story dictionary={dictionary.story} lang={lang} />
        </section>

                       <h1 className="bg-red-400 text-[30px]">
          {dictionary.title}
        </h1>

        {/* Contact Section */}
        <section id="contact" aria-label={dictionary.contact?.ariaLabel || "Contact us"} className="scroll-mt-20">
