...
// <div className="flex flex-col md:flex-row justify-center items-center gap-6 mx-auto text-center h-[200px]">
//   {/* Logo */}
//   <img
...
//   {/* Text */}
//   <h3 className="prompto text-4xl md:text-6xl italic font-bold outline-text animated-block">
//     KSA
//   </h3>
// </div>
